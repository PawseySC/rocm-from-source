...
echo "setenv(\"HIP_PATH\", \"${ROCM_INSTALL_DIR}\")"
...
echo "setenv(\"LDFLAGS\", \"-L${COMPILER_LIBDIR} -Wl,-rpath=${COMPILER_LIBDIR}\")"
echo "set_alias(\"hipcc\", \"hipcc -L${COMPILER_LIBDIR} -Wl,-rpath=${COMPILER_LIBDIR}\")"
echo "end"
